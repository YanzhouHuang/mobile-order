package com.android.yanzhou.huang.model;
...
import com.android.yanzhou.huang.exception.ProductNotFoundException;
import com.android.yanzhou.huang.exception.QuantityOutOfRangeException;
...
public class Cart implements Serializable {
   ...
   /* private BigDecimal EachPrice = BigDecimal.ZERO;*/
    ...
    public void update(final Saleable sellable, int quantity ) throws ProductNotFoundException, QuantityOutOfRangeException {
      ...
      /*  EachPrice = totalPrice.subtract(productPrice); */
    }
